...
void BaseLevel::initScene() {
    ...
    setBackgroundBrush(QBrush(QPixmap(":/images/background-1.png").scaledToHeight(game->height()))); // Setting Background for scene. TODO: Put this image in Level Settings.
