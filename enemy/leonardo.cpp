...
Leonardo::Leonardo(int left, int right, int initialPos, int speed) : MovingEnemy(left, right, initialPos, speed, 3, 1) {
    f0 = QPixmap(":/images/Level 3/leonardo/frame_0_delay-0.1s.png").scaledToWidth(100);
    f1 = QPixmap(":/images/Level 3/leonardo/frame_1_delay-0.1s.png").scaledToWidth(100);
    f2 = QPixmap(":/images/Level 3/leonardo/frame_2_delay-0.1s.png").scaledToWidth(100);
    f3 = QPixmap(":/images/Level 3/leonardo/frame_3_delay-0.1s.png").scaledToWidth(100);
...
void Leonardo::animate()
{
    ...
    // }
    // Utils::traverseFrames(frames, pixmap, 200);
    Utils::traverseFrames(frames, *pixmap, 200);
    update();
}
